...
class Revertbtn(ctk.CTkButton):
  def __init__(self,parent,*args):
    ...
    self.ctkImage = ctk.CTkImage(
      light_image = Image.open('image-editor-class12\Images\\back (1).png'), 
      dark_image = Image.open('image-editor-class12\Images\\backward.png')
    )
    super().__init__(
      master=parent,
      text='Revert',
...
class FilePathPanel(Panel):
  def __init__(self, parent, pathStr):
    ...
    self.imageBtn = ctk.CTkImage(
      light_image = Image.open('image-editor-class12\\Images\\case-file.png'), 
      dark_image = Image.open('image-editor-class12\\Images\\case-file.png')
    )
...
class SaveBtn(ctk.CTkButton):
  def __init__(self, parent, exportImg, nameStr, fileStr, pathStr):
    ...
    # ctk Image
    self.imageBtn = ctk.CTkImage(
      light_image = Image.open('image-editor-class12\\Images\\diskette.png'), 
      dark_image = Image.open('image-editor-class12\\Images\\diskette.png')
    )
